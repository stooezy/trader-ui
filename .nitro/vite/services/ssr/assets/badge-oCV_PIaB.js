...
var API_BASE = "https://trader.dymple.net";
...
function fetchIndicators(symbol, tf, limit = 200) {
...
//#endregion
//#region src/hooks/use-trader.ts
...
function useCandles(symbol, tf, limit = 200) {
	return useQuery({
		queryKey: [
			"candles",
			symbol,
...
function useIndicators(symbol, tf, limit = 200) {
	return useQuery({
		queryKey: [
			"indicators",
			symbol,
...
//#endregion
export { usePositions as a, useIndicators as i, useAccount as n, useScanner as o, useCandles as r, Badge as t };
